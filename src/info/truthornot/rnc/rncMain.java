...
public class rncMain {
	...
	private JLabel MSLabel_8;
	private JLabel MSLabel_9;
	private JLabel MSLabel_10;
	private JLabel MSLabel_11;
	private JLabel MSLabel_12;
	private JLabel MSLabel_13;
	private JLabel MSLabel_14;
	private JLabel MSLabel_15;
	private JLabel MSLabel_16;
	private JLabel MSLabel_17;
	private JLabel MSLabel_18;
	private JLabel MSLabel_19;
	private JLabel MSLabel_20;
	private JLabel MSLabel_21;
	...
	*/
	...
	private JLabel ES1Label_6;
	private JLabel ES1Label_7;
	private JLabel ES1Label_8;
	private JLabel ES1Label_9;
	private JLabel ES1Label_10;
	private JLabel ES1Label_11;
	private JLabel ES1Label_12;
	private JLabel ES1Label_13;
	private JLabel ES1Label_14;
	private JLabel ES1Label_15;
	private JLabel ES1Label_16;
	private JLabel ES1Label_17;
	private JLabel ES1Label_18;
	private JLabel ES1Label_19;
	private JLabel ES1Label_20;
	private JLabel ES1Label_21;
	private JLabel ES1Label_22;
	private JLabel ES1Label_23;
	private JLabel ES1Label_24;
	private JLabel ES1Label_25;
	private JLabel ES1Label_26;
	...
	public void refresh_slot_data() {
		...
		/*
		 ...
		 MSLabel_8.setIcon(Board);	
		 MSLabel_9.setIcon(Board);
		 MSLabel_10.setIcon(Board);
		 MSLabel_11.setIcon(Board);
		 MSLabel_12.setIcon(Board);
		 MSLabel_13.setIcon(Board);
		 MSLabel_14.setIcon(Board);
		 MSLabel_15.setIcon(Board);
		 MSLabel_16.setIcon(Board);
		 MSLabel_17.setIcon(Board);
		 MSLabel_18.setIcon(Board);
		 MSLabel_19.setIcon(Board);
		 MSLabel_20.setIcon(Board);
		 MSLabel_21.setIcon(Board);
		 ...
		 */
		 ...
		 ES1Label_6.setIcon(Board);	
		 ES1Label_7.setIcon(Board);	
		 ES1Label_8.setIcon(Board);	
		 ES1Label_9.setIcon(Board);
		 ES1Label_10.setIcon(Board);
		 ES1Label_11.setIcon(Board);
		 ES1Label_12.setIcon(Board);
		 ES1Label_13.setIcon(Board);
		 ES1Label_14.setIcon(Board);
		 ES1Label_15.setIcon(Board);
		 ES1Label_16.setIcon(Board);
		 ES1Label_17.setIcon(Board);
		 ES1Label_18.setIcon(Board);
		 ES1Label_19.setIcon(Board);
		 ES1Label_20.setIcon(Board);
		 ES1Label_21.setIcon(Board);
		 ES1Label_22.setIcon(Board);
		 ES1Label_23.setIcon(Board);
		 ES1Label_24.setIcon(Board);
		 ES1Label_25.setIcon(Board);
		 ES1Label_26.setIcon(Board);
		...
		for (int i = 0; i < RNC.get_MS_Count(); i++){	
			...
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("8")) MSLabel_8.setIcon(Board_selected);	
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("9")) MSLabel_9.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("10")) MSLabel_10.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("11")) MSLabel_11.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("12")) MSLabel_12.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("13")) MSLabel_13.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("14")) MSLabel_14.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("15")) MSLabel_15.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("16")) MSLabel_16.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("17")) MSLabel_17.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("18")) MSLabel_18.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("19")) MSLabel_19.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("20")) MSLabel_20.setIcon(Board_selected);
			if(RNC.get_MS_SlotData(i).get_Slot().equalsIgnoreCase("21")) MSLabel_21.setIcon(Board_selected);
		...
		for (int i = 0; i < RNC.get_ES1_Count(); i++){	
			...
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("4")) ES1Label_4.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("5")) ES1Label_5.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("6")) ES1Label_6.setIcon(Board_selected);	
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("7")) ES1Label_7.setIcon(Board_selected);	
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("8")) ES1Label_8.setIcon(Board_selected);	
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("9")) ES1Label_9.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("10")) ES1Label_10.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("11")) ES1Label_11.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("12")) ES1Label_12.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("13")) ES1Label_13.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("14")) ES1Label_14.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("15")) ES1Label_15.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("16")) ES1Label_16.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("17")) ES1Label_17.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("18")) ES1Label_18.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("19")) ES1Label_19.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("20")) ES1Label_20.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("21")) ES1Label_21.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("22")) ES1Label_22.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("23")) ES1Label_23.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("24")) ES1Label_24.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("25")) ES1Label_25.setIcon(Board_selected);
			if(RNC.get_ES1_SlotData(i).get_Slot().equalsIgnoreCase("26")) ES1Label_26.setIcon(Board_selected);
		}
		for (int i = 0; i < RNC.get_ES2_Count(); i++){	
	...
	private void initialize() {
		...
		MSLabel_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("5") == -1){
					MSLabel_5.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("5") == -1){
					MSLabel_5.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("5");
					RNC.add_MS_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					MSLabel_5.setIcon(Board);
					RNC.delete_MS_SlotData_byName("5");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_5.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("5") == -1){
					MSLabel_5.setIcon(Board_over);
				}
			}
		});
		MSLabel_5.setBounds(62, 27, 14, 193);
		panel_10.add(MSLabel_5);
		MSLabel_5.setIcon(Board);
		
		MSLabel_6 = new JLabel(""); //Slot 6
		MSLabel_6.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("6") == -1){
					MSLabel_6.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("6") == -1){
					MSLabel_6.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("6");
					RNC.add_MS_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					MSLabel_6.setIcon(Board);
					RNC.delete_MS_SlotData_byName("6");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_6.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("6") == -1){
					MSLabel_6.setIcon(Board_over);
				}	
			}
		});
		MSLabel_6.setIcon(Board);		
		MSLabel_6.setBounds(75, 27, 14, 193);
		panel_10.add(MSLabel_6);
		
		MSLabel_7 = new JLabel(""); //Slot 7
		MSLabel_7.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("7") == -1){
					MSLabel_7.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("7") == -1){
					MSLabel_7.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("7");
					RNC.add_MS_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					MSLabel_7.setIcon(Board);
					RNC.delete_MS_SlotData_byName("7");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_7.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("7") == -1){
					MSLabel_7.setIcon(Board_over);
				}
			}
		});
		MSLabel_7.setIcon(Board);
		MSLabel_7.setBounds(88, 27, 14, 193);
		panel_10.add(MSLabel_7);
		
		MSLabel_8 = new JLabel(""); // Slot 8
		MSLabel_8.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("8") == -1){
					MSLabel_8.setIcon(Board);
				}	
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("8") == -1){
					MSLabel_8.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("8");
					RNC.add_MS_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					MSLabel_8.setIcon(Board);
					RNC.delete_MS_SlotData_byName("8");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_8.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("8") == -1){
					MSLabel_8.setIcon(Board_over);
				}	
			}
		});
		MSLabel_8.setIcon(Board);
		MSLabel_8.setBounds(101, 27, 14, 193);
		panel_10.add(MSLabel_8);
		
		MSLabel_9 = new JLabel(""); // Slot 9
		MSLabel_9.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("9") == -1){
					MSLabel_9.setIcon(Board);
				}	
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("9") == -1){
					MSLabel_9.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("9");
					RNC.add_MS_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					MSLabel_9.setIcon(Board);
					RNC.delete_MS_SlotData_byName("9");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_9.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("9") == -1){
					MSLabel_9.setIcon(Board_over);
				}
			}
		});
		MSLabel_9.setIcon(Board);
		MSLabel_9.setBounds(114, 27, 14, 193);
		panel_10.add(MSLabel_9);
		
		MSLabel_10 = new JLabel(""); // Slot 10
		MSLabel_10.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("10") == -1){
					MSLabel_10.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("10") == -1){
					MSLabel_10.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_10.setIcon(Board);
					RNC.delete_MS_SlotData_byName("10");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_10.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("10") == -1){
					MSLabel_10.setIcon(Board_over);
				}
			}
		});
		MSLabel_10.setIcon(Board);
		MSLabel_10.setBounds(127, 27, 14, 193);
		panel_10.add(MSLabel_10);
		
		MSLabel_11 = new JLabel(""); //Slot 11
		MSLabel_11.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("11") == -1){
					MSLabel_11.setIcon(Board);			
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("11") == -1){
					MSLabel_11.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_11.setIcon(Board);
					RNC.delete_MS_SlotData_byName("11");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_11.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("11") == -1){
					MSLabel_11.setIcon(Board_over);
				}
			}
		});
		MSLabel_11.setIcon(Board);
		MSLabel_11.setBounds(140, 27, 14, 193);
		panel_10.add(MSLabel_11);
		
		
		MSLabel_12 = new JLabel(""); // Slot 12
		MSLabel_12.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("12") == -1){
					MSLabel_12.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("12") == -1){
					MSLabel_12.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_12.setIcon(Board);
					RNC.delete_MS_SlotData_byName("12");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_12.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("12") == -1){
					MSLabel_12.setIcon(Board_over);
				}
			}
		});
		MSLabel_12.setIcon(Board);
		MSLabel_12.setBounds(153, 27, 14, 193);
		panel_10.add(MSLabel_12);
		
		MSLabel_13 = new JLabel(""); // Slot 13
		MSLabel_13.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("13") == -1){
					MSLabel_13.setIcon(Board);
				}	
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("13") == -1){
					MSLabel_13.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_13.setIcon(Board);
					RNC.delete_MS_SlotData_byName("13");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_13.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("13") == -1){
					MSLabel_13.setIcon(Board_over);
				}
			}
		});
		MSLabel_13.setIcon(Board);
		MSLabel_13.setBounds(166, 27, 14, 193);
		panel_10.add(MSLabel_13);
		
		MSLabel_14 = new JLabel(""); // Slot 14
		MSLabel_14.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("14") == -1){
					MSLabel_14.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("14") == -1){
					MSLabel_14.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_14.setIcon(Board);
					RNC.delete_MS_SlotData_byName("14");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_14.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("14") == -1){
					MSLabel_14.setIcon(Board_over);
				}
			}
		});
		MSLabel_14.setIcon(Board);
		MSLabel_14.setBounds(179, 27, 14, 193);
		panel_10.add(MSLabel_14);
		
		MSLabel_15 = new JLabel(""); // Slot 15
		MSLabel_15.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("15") == -1){
					MSLabel_15.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("15") == -1){
					MSLabel_15.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_15.setIcon(Board);
					RNC.delete_MS_SlotData_byName("15");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_15.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("15") == -1){
					MSLabel_15.setIcon(Board_over);
				}
			}
		});
		MSLabel_15.setIcon(Board);
		MSLabel_15.setBounds(192, 27, 14, 193);
		panel_10.add(MSLabel_15);
		
		MSLabel_16 = new JLabel(""); //Slot 16
		MSLabel_16.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("16") == -1){
					MSLabel_16.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("16") == -1){
					MSLabel_16.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_16.setIcon(Board);
					RNC.delete_MS_SlotData_byName("16");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_16.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("16") == -1){
					MSLabel_16.setIcon(Board_over);
				}
			}
		});
		MSLabel_16.setIcon(Board);
		MSLabel_16.setBounds(205, 27, 14, 193);
		panel_10.add(MSLabel_16);
		
		MSLabel_17 = new JLabel(""); // Slot 17
		MSLabel_17.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("17") == -1){
					MSLabel_17.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("17") == -1){
					MSLabel_17.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_17.setIcon(Board);
					RNC.delete_MS_SlotData_byName("17");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_17.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("17") == -1){
					MSLabel_17.setIcon(Board_over);
				}
			}
		});
		MSLabel_17.setIcon(Board);
		MSLabel_17.setBounds(218, 27, 14, 193);
		panel_10.add(MSLabel_17);
		
		MSLabel_18 = new JLabel(""); // Slot 18
		MSLabel_18.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("18") == -1){
					MSLabel_18.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("18") == -1){
					MSLabel_18.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_18.setIcon(Board);
					RNC.delete_MS_SlotData_byName("18");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_18.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("18") == -1){
					MSLabel_18.setIcon(Board_over);
				}
			}
		});
		MSLabel_18.setIcon(Board);
		MSLabel_18.setBounds(231, 27, 14, 193);
		panel_10.add(MSLabel_18);
		
		MSLabel_19 = new JLabel(""); // Slot 19
		MSLabel_19.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("19") == -1){
					MSLabel_19.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("19") == -1){
					MSLabel_19.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_19.setIcon(Board);
					RNC.delete_MS_SlotData_byName("19");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_19.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("19") == -1){
					MSLabel_19.setIcon(Board_over);
				}
			}
		});
		MSLabel_19.setIcon(Board);
		MSLabel_19.setBounds(244, 27, 14, 193);
		panel_10.add(MSLabel_19);
		
		MSLabel_20 = new JLabel(""); // Slot 20
		MSLabel_20.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("20") == -1){
					MSLabel_20.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("20") == -1){
					MSLabel_20.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_20.setIcon(Board);
					RNC.delete_MS_SlotData_byName("20");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_20.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("20") == -1){
					MSLabel_20.setIcon(Board_over);
				}
			}
		});
		MSLabel_20.setIcon(Board);
		MSLabel_20.setBounds(257, 27, 14, 193);
		panel_10.add(MSLabel_20);
		
		MSLabel_21 = new JLabel(""); // Slot 21
		MSLabel_21.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("21") == -1){
					MSLabel_21.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("21") == -1){
					MSLabel_21.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_21.setIcon(Board);
					RNC.delete_MS_SlotData_byName("21");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_21.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("21") == -1){
					MSLabel_21.setIcon(Board_over);
				}
			}
		});
		MSLabel_21.setIcon(Board);
		MSLabel_21.setBounds(270, 27, 14, 193);
		panel_10.add(MSLabel_21);
		
		MSLabel_22 = new JLabel(""); // Slot 22
		MSLabel_22.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("22") == -1){
					MSLabel_22.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("22") == -1){
					MSLabel_22.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_22.setIcon(Board);
					RNC.delete_MS_SlotData_byName("22");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_22.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("22") == -1){
					MSLabel_22.setIcon(Board_over);
				}
			}
		});
		MSLabel_22.setIcon(Board);
		MSLabel_22.setBounds(283, 27, 14, 193);
		panel_10.add(MSLabel_22);
		
		MSLabel_23 = new JLabel(""); // Slot 23
		MSLabel_23.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("23") == -1){
					MSLabel_23.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("23") == -1){
					MSLabel_23.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_23.setIcon(Board);
					RNC.delete_MS_SlotData_byName("23");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_23.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("23") == -1){
					MSLabel_23.setIcon(Board_over);
				}
			}
		});
		MSLabel_23.setIcon(Board);
		MSLabel_23.setBounds(296, 27, 14, 193);
		panel_10.add(MSLabel_23);
		
		MSLabel_24 = new JLabel(""); // Slot 24
		MSLabel_24.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("24") == -1){
					MSLabel_24.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("24") == -1){
					MSLabel_24.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					MSLabel_24.setIcon(Board);
					RNC.delete_MS_SlotData_byName("24");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		MSLabel_24.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_MS_SlotData_byName("24") == -1){
					MSLabel_24.setIcon(Board_over);
				}
			}
		});
		MSLabel_24.setIcon(Board);
		...
		*/
		...
		ES1Label_3 = new JLabel(""); //Slot 3
		ES1Label_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("3") == -1){
					ES1Label_3.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("3") == -1){
					ES1Label_3.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("3");
					...
					ES1Label_3.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("3");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_3.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("3") == -1){
					ES1Label_3.setIcon(Board_over);
				}
			}
		});
		ES1Label_3.setBounds(36, 27, 14, 193);
		panel_11.add(ES1Label_3);
		ES1Label_3.setIcon(Board);
		
		ES1Label_4 = new JLabel(""); //Slot 4
		ES1Label_4.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("4") == -1){
					ES1Label_4.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("4") == -1){
					ES1Label_4.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("4");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_4.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("4");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_4.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("4") == -1){
					ES1Label_4.setIcon(Board_over);
				}
			}
		});
		ES1Label_4.setBounds(49, 27, 14, 193);
		panel_11.add(ES1Label_4);
		ES1Label_4.setIcon(Board);
		
		
		ES1Label_5 = new JLabel(""); //Slot 5
		ES1Label_5.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("5") == -1){
					ES1Label_5.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("5") == -1){
					ES1Label_5.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("5");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_5.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("5");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_5.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("5") == -1){
					ES1Label_5.setIcon(Board_over);
				}
			}
		});
		ES1Label_5.setBounds(62, 27, 14, 193);
		panel_11.add(ES1Label_5);
		ES1Label_5.setIcon(Board);
		
		ES1Label_6 = new JLabel(""); //Slot 6
		ES1Label_6.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("6") == -1){
					ES1Label_6.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("6") == -1){
					ES1Label_6.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("6");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_6.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("6");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_6.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("6") == -1){
					ES1Label_6.setIcon(Board_over);
				}	
			}
		});
		ES1Label_6.setIcon(Board);		
		ES1Label_6.setBounds(75, 27, 14, 193);
		panel_11.add(ES1Label_6);
		
		  ES1Label_7 = new JLabel(""); //Slot 7
		ES1Label_7.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("7") == -1){
					ES1Label_7.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("7") == -1){
					ES1Label_7.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("7");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_7.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("7");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_7.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("7") == -1){
					ES1Label_7.setIcon(Board_over);
				}
			}
		});
		ES1Label_7.setIcon(Board);
		ES1Label_7.setBounds(88, 27, 14, 193);
		panel_11.add(ES1Label_7);
		
		  ES1Label_8 = new JLabel(""); // Slot 8
		ES1Label_8.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("8") == -1){
					ES1Label_8.setIcon(Board);
				}	
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("8") == -1){
					ES1Label_8.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("8");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_8.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("8");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_8.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("8") == -1){
					ES1Label_8.setIcon(Board_over);
				}	
			}
		});
		ES1Label_8.setIcon(Board);
		ES1Label_8.setBounds(101, 27, 14, 193);
		panel_11.add(ES1Label_8);
		
		  ES1Label_9 = new JLabel(""); // Slot 9
		ES1Label_9.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("9") == -1){
					ES1Label_9.setIcon(Board);
				}	
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("9") == -1){
					ES1Label_9.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("9");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_9.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("9");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_9.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("9") == -1){
					ES1Label_9.setIcon(Board_over);
				}
			}
		});
		ES1Label_9.setIcon(Board);
		ES1Label_9.setBounds(114, 27, 14, 193);
		panel_11.add(ES1Label_9);
		
		  ES1Label_10 = new JLabel(""); // Slot 10
		ES1Label_10.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("10") == -1){
					ES1Label_10.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("10") == -1){
					ES1Label_10.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("10");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_10.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("10");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_10.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("10") == -1){
					ES1Label_10.setIcon(Board_over);
				}
			}
		});
		ES1Label_10.setIcon(Board);
		ES1Label_10.setBounds(127, 27, 14, 193);
		panel_11.add(ES1Label_10);
		
		  ES1Label_11 = new JLabel(""); //Slot 11
		ES1Label_11.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("11") == -1){
					ES1Label_11.setIcon(Board);			
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("11") == -1){
					ES1Label_11.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("11");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_11.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("11");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_11.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("11") == -1){
					ES1Label_11.setIcon(Board_over);
				}
			}
		});
		ES1Label_11.setIcon(Board);
		ES1Label_11.setBounds(140, 27, 14, 193);
		panel_11.add(ES1Label_11);
		
		
		  ES1Label_12 = new JLabel(""); // Slot 12
		ES1Label_12.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("12") == -1){
					ES1Label_12.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("12") == -1){
					ES1Label_12.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("12");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_12.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("12");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_12.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("12") == -1){
					ES1Label_12.setIcon(Board_over);
				}
			}
		});
		ES1Label_12.setIcon(Board);
		ES1Label_12.setBounds(153, 27, 14, 193);
		panel_11.add(ES1Label_12);
		
		  ES1Label_13 = new JLabel(""); // Slot 13
		ES1Label_13.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("13") == -1){
					ES1Label_13.setIcon(Board);
				}	
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("13") == -1){
					ES1Label_13.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("13");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_13.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("13");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_13.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("13") == -1){
					ES1Label_13.setIcon(Board_over);
				}
			}
		});
		ES1Label_13.setIcon(Board);
		ES1Label_13.setBounds(166, 27, 14, 193);
		panel_11.add(ES1Label_13);
		
		  ES1Label_14 = new JLabel(""); // Slot 14
		ES1Label_14.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("14") == -1){
					ES1Label_14.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("14") == -1){
					ES1Label_14.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("14");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_14.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("14");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_14.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("14") == -1){
					ES1Label_14.setIcon(Board_over);
				}
			}
		});
		ES1Label_14.setIcon(Board);
		ES1Label_14.setBounds(179, 27, 14, 193);
		panel_11.add(ES1Label_14);
		
		  ES1Label_15 = new JLabel(""); // Slot 15
		ES1Label_15.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("15") == -1){
					ES1Label_15.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("15") == -1){
					ES1Label_15.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("15");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_15.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("15");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_15.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("15") == -1){
					ES1Label_15.setIcon(Board_over);
				}
			}
		});
		ES1Label_15.setIcon(Board);
		ES1Label_15.setBounds(192, 27, 14, 193);
		panel_11.add(ES1Label_15);
		
		  ES1Label_16 = new JLabel(""); //Slot 16
		ES1Label_16.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("16") == -1){
					ES1Label_16.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("16") == -1){
					ES1Label_16.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("16");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_16.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("16");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_16.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("16") == -1){
					ES1Label_16.setIcon(Board_over);
				}
			}
		});
		ES1Label_16.setIcon(Board);
		ES1Label_16.setBounds(205, 27, 14, 193);
		panel_11.add(ES1Label_16);
		
		  ES1Label_17 = new JLabel(""); // Slot 17
		ES1Label_17.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("17") == -1){
					ES1Label_17.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("17") == -1){
					ES1Label_17.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("17");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_17.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("17");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_17.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("17") == -1){
					ES1Label_17.setIcon(Board_over);
				}
			}
		});
		ES1Label_17.setIcon(Board);
		ES1Label_17.setBounds(218, 27, 14, 193);
		panel_11.add(ES1Label_17);
		
		  ES1Label_18 = new JLabel(""); // Slot 18
		ES1Label_18.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("18") == -1){
					ES1Label_18.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("18") == -1){
					ES1Label_18.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("18");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_18.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("18");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_18.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("18") == -1){
					ES1Label_18.setIcon(Board_over);
				}
			}
		});
		ES1Label_18.setIcon(Board);
		ES1Label_18.setBounds(231, 27, 14, 193);
		panel_11.add(ES1Label_18);
		
		  ES1Label_19 = new JLabel(""); // Slot 19
		ES1Label_19.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("19") == -1){
					ES1Label_19.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("19") == -1){
					ES1Label_19.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("19");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_19.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("19");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_19.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("19") == -1){
					ES1Label_19.setIcon(Board_over);
				}
			}
		});
		ES1Label_19.setIcon(Board);
		ES1Label_19.setBounds(244, 27, 14, 193);
		panel_11.add(ES1Label_19);
		
		  ES1Label_20 = new JLabel(""); // Slot 20
		ES1Label_20.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("20") == -1){
					ES1Label_20.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("20") == -1){
					ES1Label_20.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("20");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_20.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("20");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_20.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("20") == -1){
					ES1Label_20.setIcon(Board_over);
				}
			}
		});
		ES1Label_20.setIcon(Board);
		ES1Label_20.setBounds(257, 27, 14, 193);
		panel_11.add(ES1Label_20);
		
		  ES1Label_21 = new JLabel(""); // Slot 21
		ES1Label_21.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("21") == -1){
					ES1Label_21.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("21") == -1){
					ES1Label_21.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("21");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_21.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("21");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_21.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("21") == -1){
					ES1Label_21.setIcon(Board_over);
				}
			}
		});
		ES1Label_21.setIcon(Board);
		ES1Label_21.setBounds(270, 27, 14, 193);
		panel_11.add(ES1Label_21);
		
		  ES1Label_22 = new JLabel(""); // Slot 22
		ES1Label_22.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("22") == -1){
					ES1Label_22.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("22") == -1){
					ES1Label_22.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("22");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_22.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("22");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_22.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("22") == -1){
					ES1Label_22.setIcon(Board_over);
				}
			}
		});
		ES1Label_22.setIcon(Board);
		ES1Label_22.setBounds(283, 27, 14, 193);
		panel_11.add(ES1Label_22);
		
		  ES1Label_23 = new JLabel(""); // Slot 23
		ES1Label_23.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("23") == -1){
					ES1Label_23.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("23") == -1){
					ES1Label_23.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("23");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_23.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("23");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_23.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("23") == -1){
					ES1Label_23.setIcon(Board_over);
				}
			}
		});
		ES1Label_23.setIcon(Board);
		ES1Label_23.setBounds(296, 27, 14, 193);
		panel_11.add(ES1Label_23);
		
		  ES1Label_24 = new JLabel(""); // Slot 24
		ES1Label_24.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("24") == -1){
					ES1Label_24.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("24") == -1){
					ES1Label_24.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					newBoard.set_Slot("24");
					RNC.add_ES1_SlotData(newBoard);
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					...
					ES1Label_24.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("24");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_24.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("24") == -1){
					ES1Label_24.setIcon(Board_over);
				}
			}
		});
		ES1Label_24.setIcon(Board);
		ES1Label_24.setBounds(309, 27, 14, 193);
		panel_11.add(ES1Label_24);
		
		  ES1Label_25 = new JLabel(""); // Slot 25
		ES1Label_25.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("25") == -1){
					ES1Label_25.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("25") == -1){
					ES1Label_25.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					ES1Label_25.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("25");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_25.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("25") == -1){
					ES1Label_25.setIcon(Board_over);
				}
			}
		});
		ES1Label_25.setIcon(Board);
		ES1Label_25.setBounds(322, 27, 14, 193);
		panel_11.add(ES1Label_25);
		
		  ES1Label_26 = new JLabel(""); // Slot 26
		ES1Label_26.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("26") == -1){
					ES1Label_26.setIcon(Board);
				}
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("26") == -1){
					ES1Label_26.setIcon(Board_selected);
					SlotData newBoard = new SlotData();
					...
					ES1Label_26.setIcon(Board);
					RNC.delete_ES1_SlotData_byName("26");
					textField.setText(String.valueOf(RNC.get_Total_Board()));
					textField_1.setText(RNC.get_Total_Board_List());
				}
			}
		});
		ES1Label_26.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {
				if (RNC.get_ES1_SlotData_byName("26") == -1){
					ES1Label_26.setIcon(Board_over);
				}
			}
		});
		ES1Label_26.setIcon(Board);
		ES1Label_26.setBounds(335, 27, 14, 193);
		panel_11.add(ES1Label_26);
